...
live2d_settings['modelTexturesId']      = 48;           // 默认材质 ID，可在 F12 控制台找到
...
live2d_settings['homePageUrl']          = 'https://blog.astrarails.org';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://blog.astrarails.org/about/';   // 关于页地址, '{URL 网址}'
